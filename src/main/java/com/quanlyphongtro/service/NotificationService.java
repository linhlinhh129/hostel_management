...
public interface NotificationService {
        ...
        List<Notification> getNotificationsForTenant(int roomId, int facilityId, String keyword, int page,
                        int pageSize);
         ...
         *
         * @throws AccessDeniedException    nếu manager không có quyền gửi đến đối tượng
         *                                  đó
         * @throws IllegalArgumentException nếu recipientType hoặc recipientId không hợp
         *                                  lệ
         */
        ...
        /**
         * Gửi yêu cầu sửa chỉ số điện nước cho Operator (tạo request + cập nhật
         * meter_reading).
         *
