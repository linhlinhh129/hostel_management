...
public interface ContractService {
    ...
    Map<String, Object> addTenantFromContract(int contractId, int roomId, String fullName, String phone, String email, String identityNumber, String permanentAddress, String gender, String dobStr, String contractStartDateStr, boolean confirmReactivate, int managerId) throws Exception;
