...
@WebServlet(name = "TenantNewsFeedServlet", urlPatterns = "/tenant/news-feed")
public class TenantNewsFeedServlet extends BaseServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<NewsFeedDTO> posts = postService.getNewsFeed(currentUser.getId());
        req.setAttribute("posts", posts);
        
        req.getRequestDispatcher("/WEB-INF/views/tenant/news-feed.jsp").forward(req, resp);
    }
}
