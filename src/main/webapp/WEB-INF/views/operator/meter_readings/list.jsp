            ...
            <div class="data-surface">
                ...
                <form method="get" action="${ctx}/operator/meter-readings"
                    ...
                    <div style="display:flex; justify-content:flex-end; gap:12px; border-top:1px dashed var(--hms-border-soft); padding-top:16px;">
                        ...
                        <button type="submit"
                                style="display:inline-flex; align-items:center; background:#fff; border:1px solid var(--hms-border); border-radius:20px; padding:6px 20px; color:var(--hms-text); font-size:14px; font-weight:500; cursor:pointer;">Lọc danh sách</button>
                    </div>
                </form>
                                ...
                                <c:otherwise>
                                    <c:forEach var="item" items="${meterList}">
                                        <tr>
                                            ...
                                            <td>
                                                <%-- Thống nhất dùng btn-mintlify-secondary cho tất cả thao tác trong bảng --%>
                ...
                <div class="table-footer d-flex justify-content-between align-items-center px-3 py-2" id="meterFooter">
