                                        ...
                                        <div style="display:flex; flex-wrap:wrap; gap:20px; margin-bottom:20px;">
                                            <div style="flex:2; min-width:180px;">
                                                ...
                                                <input type="text" class="form-control" name="roomCode"
                                                    placeholder="Mã phòng..." value="<c:out value='${searchRoomCode}'/>"
                                                    style="width:100%">
                                            </div>
                                            <div style="flex:1; min-width:120px;">
                                                <label
                                                    style="display:block; font-size:13px; font-weight:600; color:var(--hms-text-muted); margin-bottom:8px;">Tháng</label>
                                            ...
                                            <div style="flex:1; min-width:120px;">
                                                <label
                                                    style="display:block; font-size:13px; font-weight:600; color:var(--hms-text-muted); margin-bottom:8px;">Năm</label>
                                                <select class="form-select" name="year" style="width:100%">
                                                    <c:forEach var="y" begin="${currentYear - 2}" end="${currentYear}">
                                                        <option value="${y}" ${selectedYear==y ? 'selected' : '' }>Năm
                                                            ${y}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                ...
                                <div class="modal fade" id="detailModal" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-lg modal-dialog-centered">
                                        <div class="modal-content"
                                            style="border-radius:var(--hms-radius-lg); border:none;">
                                            <div class="modal-header border-0 pb-0">
                                                <h5 class="modal-title fw-bold" id="detailModalLabel">
                                                    Chi tiết điện nước phòng <span id="modalRoomCode"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="p-3 rounded" style="background:var(--hms-bg-soft)">
                                                            ...
                                                            <div class="mt-3 text-center">
                                                                ...
                                                                <span id="noElectricImg" class="text-muted fst-italic"
                                                                    style="display:none">Không có ảnh</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="p-3 rounded" style="background:var(--hms-bg-soft)">
                                                            ...
                                                            <div class="mt-3 text-center">
                                                                <img id="modalWaterImg" src="" alt="Ảnh công tơ nước"
                                                                    class="img-fluid rounded"
                                                                    style="max-height:200px; object-fit:contain; display:none; width:100%; background:#f8f9fa;">
                                                                <span id="noWaterImg" class="text-muted fst-italic"
                                                                    style="display:none">Không có ảnh</span>
                                                            </div>
                                                        </div>
                                                    </div>
