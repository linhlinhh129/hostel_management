                                ...
                                <div class="col-lg-4 right-panel">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="mintlify-property-row">
                                            ...
                                            <div class="mintlify-property-value">P.${reqDetail.roomCode} - ${reqDetail.facilityName}</div>
                                        </div>
                                        <div class="mintlify-property-row">
                                    ...
                                    <div class="mb-5">
                                        <c:choose>
                                            ...
                                            <c:when test="${reqDetail.status == 'ASSIGNED' && reqDetail.assignedStaffId == sessionScope.currentUser.id}">
                                                <div class="p-4" style="background: linear-gradient(145deg, #ffffff, #f8fafc); border: 1px solid #e2e8f0; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05);">
                                            ...
                                            <c:otherwise>
                                                <div class="text-center p-3 rounded"
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:when test="${reqDetail.status == 'COMPLETED' || reqDetail.status == 'DONE'}">
                                                            <span class="mintlify-badge-status-done" style="display:inline-block; padding: 4px 10px; border-radius: 4px; font-size: 11px; font-weight: 600; background: var(--color-brand-green); color: var(--color-primary); margin-bottom:6px">Hoàn thành</span>
