...
<c:if test="${empty pageTitle}"><c:set var="pageTitle" value="Quản lý Nhà trọ"/></c:if>
<!DOCTYPE html>
<html lang="vi">
<head>
    <meta charset="UTF-8">
    ...
    <meta name="apple-mobile-web-app-title" content="HomeX">
    ...
    <link href="${ctx}/assets/css/hostel-design.css?v=24" rel="stylesheet">
