        ...
        <c:if test="${role == 'TENANT'}">
            ...
            <a href="${ctx}/tenant/dependents" class="sidebar-link${menu == 'dependents' ? ' active' : ''}">
                ...
                <c:if test="${role == 'OPERATOR'}">
                    ...
                    <a href="${ctx}/operator/requests" class="sidebar-link${menu == 'requests' || menu == 'tickets' ? ' active' : ''}">
                    ...
                    <a href="${ctx}/operator/notifications" class="sidebar-link${menu == 'notifications' ? ' active' : ''}">
