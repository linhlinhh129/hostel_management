        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                <c:if test="${role == 'ADMIN'}">
                    ...
                    <a href="${ctx}/admin/system-config" class="sidebar-link${menu == 'system-config' ? ' active' : ''}">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <c:if test="${role == 'MANAGER'}">
                    ...
                    <a href="${ctx}/manager/service-prices"
                        class="sidebar-link${menu == 'service-prices' ? ' active' : ''}">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <c:if test="${role == 'TENANT'}">
                    ...
                    <div class="sidebar-section">Cộng đồng</div>
                    <a href="${ctx}/tenant/news-feed" class="sidebar-link${menu == 'news-feed' ? ' active' : ''}">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="${ctx}/tenant/my-posts" class="sidebar-link${menu == 'my-posts' ? ' active' : ''}">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
                            <path d="M14 2v6h6" />
                            <line x1="16" y1="13" x2="8" y2="13" />
                    ...
                    <a href="${ctx}/tenant/contracts" class="sidebar-link${menu == 'contracts' ? ' active' : ''}">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
                            <polyline points="14 2 14 8 20 8" />
                            <line x1="16" y1="13" x2="8" y2="13" />
                ...
                <c:if test="${role == 'OPERATOR'}">
                    ...
                    <a href="${ctx}/operator/meter-readings/history"
                        class="sidebar-link${menu == 'meter-readings-history' ? ' active' : ''}">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="${ctx}/operator/requests"
                        class="sidebar-link${menu == 'requests' || menu == 'tickets' ? ' active' : ''}">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
                        </svg>
                        Danh sách yêu cầu
                    </a>
                    <a href="${ctx}/operator/incidents/create"
                        class="sidebar-link${menu == 'incident-report' ? ' active' : ''}">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path
                    ...
                    <a href="${ctx}/operator/incidents/my-reports"
                        class="sidebar-link${menu == 'my-incidents' ? ' active' : ''}">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <polyline points="14 2 14 8 20 8" />
                            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
                            <path d="M12 18v-6" />
                    ...
                    <a href="${ctx}/operator/notifications"
                        class="sidebar-link${menu == 'notifications' ? ' active' : ''}">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" />
                            <path d="M13.73 21a2 2 0 0 1-3.46 0" />
