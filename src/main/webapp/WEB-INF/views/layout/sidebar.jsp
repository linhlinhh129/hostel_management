...
<aside class="sidebar">
        ...
        <div class="sidebar-brand-text">
            ...
            <small>
                <c:choose>
                    ...
                    <c:when test="${role == 'MANAGER'}">Ban Quản lý<c:if test="${not empty sessionScope.currentUser.facilityCode}"> · <c:out value="${sessionScope.currentUser.facilityCode}"/></c:if></c:when>
                    <c:when test="${role == 'TENANT'}"><c:out value="${empty sessionScope.currentUser.roomCode ? 'Cư dân' : sessionScope.currentUser.roomCode}"/></c:when>
    ...
    <nav class="sidebar-nav">
        <c:if test="${role == 'ADMIN'}">
            ...
            <a href="${ctx}/admin/facilities" class="sidebar-link${menu == 'hostels' or menu == 'facilities' ? ' active' : ''}">
            ...
            <a href="${ctx}/admin/personnel" class="sidebar-link${menu == 'personnel' ? ' active' : ''}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><path d="M12 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z"/></svg>
                Quản lý nhân sự
            </a>
            <a href="${ctx}/admin/notifications" class="sidebar-link${menu == 'notifications' ? ' active' : ''}">
        ...
        <c:if test="${role == 'MANAGER'}">
            ...
            <a href="${ctx}/manager/tickets" class="sidebar-link${menu == 'tickets' ? ' active' : ''}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="9 11 12 14 22 4"/></svg>
                Yêu cầu
            </a>
            ...
            <a href="${ctx}/manager/notifications" class="sidebar-link${menu == 'notifications' ? ' active' : ''}">
        ...
        <c:if test="${role == 'TENANT'}">
            <a href="${ctx}/tenant/dashboard" class="sidebar-link${menu == 'dashboard' ? ' active' : ''}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/></svg>
                Dashboard
            </a>
            <div class="sidebar-section">Dịch vụ</div>
            <a href="${ctx}/tenant/invoices" class="sidebar-link${menu == 'invoices' ? ' active' : ''}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>
                Hóa đơn
            </a>
            <a href="${ctx}/tenant/tickets" class="sidebar-link${menu == 'tickets' ? ' active' : ''}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="9 11 12 14 22 4"/></svg>
                Yêu cầu
            </a>
            <a href="${ctx}/tenant/notifications" class="sidebar-link${menu == 'notifications' ? ' active' : ''}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/></svg>
                Thông báo
            </a>
            <div class="sidebar-section">Cá nhân</div>
            <a href="${ctx}/tenant/dependents" class="sidebar-link${menu == 'dependents' ? ' active' : ''}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg>
                Người phụ thuộc
            </a>
        </c:if>
