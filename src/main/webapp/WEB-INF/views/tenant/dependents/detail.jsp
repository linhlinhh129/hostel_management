...
<c:set var="pageTitle" value="Chi tiết ngư�?i phụ thuộc"/>
...
<div class="tenant-card"><p><strong>Ngày sinh:</strong> <c:out value="${dependent.dobLabel}"/></p><p><strong>S�?T:</strong> <c:out value="${dependent.phone}"/></p><p><strong>CCCD:</strong> <c:out value="${dependent.maskedIdentityNumber}"/></p><p><strong>Quan hệ:</strong> <c:out value="${dependent.relationship}"/></p></div>
