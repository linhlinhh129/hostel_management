                            ...
                            <div class="page-header hero-sky-gradient"
                                ...
                                <div
                                    ...
                                    <div>
                                        ...
                                        <p>Tổng quan doanh thu toàn hệ thống — tháng
                                            <c:out value="${selectedPeriod}" />
                                        </p>
                                    </div>
                                    <!-- Chức năng -->
                                    <div
                                        style="display:flex;gap:12px;align-items:center;position:relative;z-index:1;flex-wrap:wrap">
                                        <!-- Chọn kỳ -->
                                        <form method="get" action="${ctx}/admin/revenue"
                                            ...
                                            <button type="submit" style="background:#ffffff;border:1px solid rgba(255,255,255,0.8);
                                                       ...
                                                       white-space:nowrap;color:var(--hms-accent-deep);
                            ...
                            <c:if test="${not empty systemRevenue}">
                                <div class="kpi-grid" style="margin-bottom:1.75rem">
                                    ...
                                    <div class="kpi-surface-card highlight-warning">
                                        ...
                                        <span class="kpi-value" style="font-size:1.5rem">
                                            <fmt:formatNumber value="${systemRevenue.totalOutstanding}"
                                                pattern="#,##0" /> đ
                                        </span>
                                    </div>
                                    <div class="kpi-surface-card highlight-accent">
                                        ...
                                        <span class="kpi-value" style="font-size:1.5rem">
                                            <fmt:formatNumber value="${systemRevenue.totalBilledAmount}"
                                                pattern="#,##0" /> đ
                                        </span>
                                    </div>
                                ...
                                <div class="data-surface" style="margin:0">
                                    <div class="data-surface-header">
                                        ...
                                        <a href="${ctx}/admin/revenue/by-facility?period=${selectedPeriod}"
                                            style="font-size:0.75rem;color:var(--hms-accent-deep);font-weight:600;text-decoration:none;white-space:nowrap">
                                            Xem đầy đủ →
                                        </a>
                                    </div>
                                    ...
                                    <c:choose>
                                                        ...
                                                        <c:forEach var="rev" items="${facilityRevenues}">
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <div
                                                                        style="font-size:0.6875rem;color:var(--hms-stone)">
                                                                        <c:out value="${rev.facilityName}" />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div style="font-weight:700;white-space:nowrap">
                                                                        <fmt:formatNumber value="${rev.totalRevenue}"
                                                                            pattern="#,##0" /> đ
                                                                    </div>
                                                                    <div
                                                                        style="font-size:0.6875rem;color:var(--hms-stone);margin-top:1px">
                                                                        <span
                                                                            style="color:var(--hms-success);font-weight:600">${rev.paidCount}</span>
                                                                        HĐ
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div
                                                                        style="font-weight:700;color:var(--hms-warning);white-space:nowrap">
                                                                        <fmt:formatNumber
                                                                            value="${rev.totalOutstanding}"
                                                                            pattern="#,##0" /> đ
                                                                    </div>
                                                                    <c:set var="unpaidTotal"
                                                                        value="${rev.unpaidCount + rev.overdueCount}" />
                                                                    <div
                                                                        style="font-size:0.6875rem;color:var(--hms-stone);margin-top:1px">
                                                                        ${unpaidTotal} HĐ<c:if
                                                                            test="${rev.overdueCount > 0}"> (<span
                                                                                style="color:var(--hms-danger);font-weight:600">${rev.overdueCount}
                                                                                trễ</span>)</c:if>
                                                                    </div>
                                                                </td>
                                                                <td
                                                                    style="font-weight:700;color:var(--hms-accent-deep);white-space:nowrap">
                                                                    <fmt:formatNumber value="${rev.totalBilledAmount}"
                                                                        pattern="#,##0" /> đ
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                                        ...
                                        <c:otherwise>
                                            <div class="empty-state" style="padding:2rem 1rem">
                                                ...
                                                <p style="font-size:0.8125rem">Tháng
                                                    <c:out value="${selectedPeriod}" />
                                                </p>
                                            </div>
                                        </c:otherwise>
                                                    ...
                                                    <tbody>
                                                        <c:forEach var="rev" items="${periodRevenues}">
                                                            <tr>
                                                                <td>
                                                                    <span
                                                                        style="font-weight:700;color:var(--hms-accent-deep)">
                                                                        <c:out value="${rev.facilityCode}" />
                                                                    </span>
                                                                </td>
                                                                <td>
