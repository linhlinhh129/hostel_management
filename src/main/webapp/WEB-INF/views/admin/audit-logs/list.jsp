    ...
    <div class="main-wrapper">
        ...
        <main class="page-content">
            ...
            <div class="data-surface">
                <%-- Filter bar --%>
                <form method="get" action="${ctx}/admin/audit-logs"
                    ...
                    <div style="display:flex;justify-content:flex-end;gap:12px;
                        ...
                        <button type="submit"
                                style="display:inline-flex;align-items:center;background:#fff;
                                       ...
                                       font-weight:500;cursor:pointer;transition:all 0.2s">Lọc dữ liệu</button>
                    </div>
                                ...
                                <c:forEach var="log" items="${auditLogs}">
                                    <tr data-href="${ctx}/admin/audit-logs/${log.id}">
                                        ...
                                        <td class="d-none d-md-table-cell"
                                            style="white-space:nowrap;font-size:0.8125rem;color:var(--hms-text-muted)">
                                            <c:if test="${not empty log.createdAt}">
                                                <span><fmt:formatDate value="${log.createdAtAsDate}" pattern="dd/MM/yyyy"/></span>
                                                <br/>
                                                <span style="font-size:0.75rem">
                                                    <fmt:formatDate value="${log.createdAtAsDate}" pattern="HH:mm"/>
                                                </span>
                                            </c:if>
                                        </td>
                                        <td class="d-none d-md-table-cell">
                                            <div style="display:flex;align-items:center;gap:8px">
                                                <div style="width:26px;height:26px;border-radius:6px;
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${not empty log.createdByName}">
                                                            ${fn:substring(log.createdByName, 0, 1)}
                                                        </c:when>
                                        ...
                                        <td>
                                            <span style="font-size:0.8125rem;font-weight:500">
                                                <jsp:include page="_audit-badges.jsp">
                                                    ...
                                                    <jsp:param name="entityTypeValue" value="${log.entityType}"/>
                                                </jsp:include>
                                            </span>
                                        </td>
                                        <td>
                                            <jsp:include page="_audit-badges.jsp">
                                                ...
                                                <jsp:param name="actionValue" value="${log.action}"/>
                                            </jsp:include>
                                        </td>
                                        <td class="d-none d-md-table-cell">
                                            <a href="${ctx}/admin/audit-logs/${log.id}"
