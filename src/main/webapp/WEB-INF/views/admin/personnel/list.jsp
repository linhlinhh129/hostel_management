    ...
    <div class="main-wrapper">
        ...
        <main class="page-content">
            ...
            <div class="data-surface">
                <%-- Filter bar --%>
                <form method="get" action="${ctx}/admin/personnel"
                                        ...
                                        <tr data-href="${ctx}/admin/personnel/${emp.id}">
                                            ...
                                            <td class="d-none d-lg-table-cell">
                                                <jsp:include page="_personnel-badges.jsp">
                                                    ...
                                                    <jsp:param name="roleValue" value="${emp.role}"/>
                                                </jsp:include>
                                            </td>
                                            <td class="d-none d-lg-table-cell">
                                                <c:choose>
                                            ...
                                            <td>
                                                <jsp:include page="_personnel-badges.jsp">
                                                    ...
                                                    <jsp:param name="statusValue" value="${emp.status}"/>
                                                </jsp:include>
                                            </td>
                                            <td class="d-none d-lg-table-cell">
                                                <a href="${ctx}/admin/personnel/${emp.id}"
                        ...
                        <div class="table-footer d-flex justify-content-between align-items-center px-3 py-2">
                            ...
                            <div class="d-flex gap-1">
                                <c:if test="${page.page > 1}">
                                    <a href="${ctx}/admin/personnel?page=${page.page - 1}&keyword=<c:out value='${keyword}'/>&role=<c:out value='${selectedRole}'/>&status=<c:out value='${selectedStatus}'/>"
