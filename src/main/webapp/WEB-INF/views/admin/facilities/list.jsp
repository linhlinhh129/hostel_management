    ...
    <div class="main-wrapper">
        ...
        <main class="page-content">
            ...
            <div class="data-surface">
                <%-- Filter bar --%>
                <form method="get" action="${ctx}/admin/facilities"
                                ...
                                <tbody>
                                    <c:forEach var="f" items="${page.items}">
                                        <tr data-href="${ctx}/admin/facilities/${f.id}">
                                            <td>
                                                <a href="${ctx}/admin/facilities/${f.id}">
                                                    <c:out value="${f.code}"/>
                                                </a>
                                            </td>
                                            ...
                                            <td class="d-none d-lg-table-cell">
                                                <fmt:formatNumber value="${f.totalRooms}" groupingUsed="true"/>
                                            </td>
                                            <td>
                                                <jsp:include page="_facility-status-badge.jsp">
                                                    <jsp:param name="statusValue" value="${f.status}"/>
                                                </jsp:include>
                                            </td>
                                            <td class="d-none d-lg-table-cell">
                                                <a href="${ctx}/admin/facilities/${f.id}"
                        ...
                        <div class="table-footer d-flex justify-content-between align-items-center px-3 py-2">
                            ...
                            <div class="d-flex gap-1">
                                <c:if test="${page.page > 1}">
                                    <a href="${ctx}/admin/facilities?page=${page.page - 1}&keyword=<c:out value='${keyword}'/>&status=<c:out value='${selectedStatus}'/>"
