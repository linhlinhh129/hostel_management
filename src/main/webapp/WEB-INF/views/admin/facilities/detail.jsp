                                    ...
                                    <div class="d-flex gap-2 flex-wrap" style="position:relative;z-index:1">
                                        ...
                                        <c:if test="${facility.status == 'ACTIVE'}">
                                            <a href="${ctx}/admin/facilities/${facility.id}/edit"
                                                class="quick-action-btn">Sửa</a>
                                            <form method="post"
                                                action="${ctx}/admin/facilities/${facility.id}/deactivate"
                                                style="margin:0">
                                                <input type="hidden" name="csrfToken" value="${csrfToken}" />
                                                ...
                                                <div class="widget-surface-body">
                                                    <table class="info-table">
                                                        ...
                                                        <tr>
                                                            <td colspan="2">
                                                                <hr
                                                                    style="margin:0.5rem 0; border-color:var(--hms-border)">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="info-label">Giá điện</td>
                                                            <td class="info-value">
                                                                <fmt:formatNumber value="${facility.electricityPrice}"
                                                                    pattern="#,##0" /> đ
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="info-label">Giá nước</td>
                                                            <td class="info-value">
                                                                <fmt:formatNumber value="${facility.waterPrice}"
                                                                    pattern="#,##0" /> đ
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="info-label">Phí Internet</td>
                                                            <td class="info-value">
                                                                <fmt:formatNumber value="${facility.internetFee}"
                                                                    pattern="#,##0" /> đ
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="info-label">Phí dịch vụ</td>
                                                            <td class="info-value">
                                                                <fmt:formatNumber value="${facility.serviceFee}"
                                                                    pattern="#,##0" /> đ
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="info-value" style="font-size:0.8125rem">
                                                                <fmt:formatDate value="${facility.createdAtAsDate}"
                                                    ...
                                                    <c:if test="${facility.status == 'DRAFT'}">
                                                        <div class="alert alert-warning mt-3"
                                                            ...
                                                            Cơ sở chưa được kích hoạt. Nhấn <strong>Kích hoạt</strong>
                                                            để hệ thống sinh phòng tự động.
                                                        </div>
                                                    </c:if>
                                                    <c:if test="${facility.status == 'INACTIVE'}">
                                                        <div class="alert alert-secondary mt-3"
                                                            style="font-size:0.8125rem;border-radius:8px">
                                                            Cơ sở đã bị vô hiệu hóa. Không thể tạo dữ liệu mới nhưng vẫn
                                                            xem được lịch sử.
                                                        </div>
                                                    </c:if>
                                                </div>
                                                                    ...
                                                                    <table class="table-mintlify">
                                                                        ...
                                                                        <tbody>
                                                                            <c:forEach var="room" items="${rooms}">
                                                                                <tr
                                                                                    data-href="${ctx}/admin/rooms/${room.id}">
