        ...
        <main class="page-content">
            ...
            <c:if test="${not empty successMessage}">
                <div class="alert alert-success alert-dismissible fade show mb-4" role="alert"
                     id="flash-success">
                    <c:choose>
                        <c:when test="${successMessage == 'email_updated'}">Cấu hình Email đã được cập nhật thành công.</c:when>
                        <c:when test="${successMessage == 'vnpay_updated'}">Cấu hình VNPay đã được cập nhật thành công.</c:when>
                        <c:otherwise><c:out value="${successMessage}"/></c:otherwise>
                    </c:choose>
            ...
            <ul class="nav nav-pills mb-4" id="config-tabs" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link ${param.tab == 'vnpay' ? 'active' : ''}"
                            id="vnpay-tab" data-bs-toggle="pill"
                            data-bs-target="#vnpay-pane" type="button" role="tab"
                            aria-controls="vnpay-pane"
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-7">
                            <div class="widget-surface">
                                ...
                                <div class="widget-surface-body">
                                    <dl class="row mb-0" style="font-size:0.9rem;row-gap:0.5rem">
                                        <dt class="col-sm-4" style="color:var(--hms-stone);font-weight:500">SMTP Host</dt>
                                        <dd class="col-sm-8 mb-0" style="font-weight:600;word-break:break-all">
                                            <c:out value="${emailConfig.host}"/>
                                        </dd>

                                        <dt class="col-sm-4" style="color:var(--hms-stone);font-weight:500">SMTP Port</dt>
                                        <dd class="col-sm-8 mb-0" style="font-weight:600">
                                            <c:out value="${emailConfig.port}"/>
                                        </dd>

                                        <dt class="col-sm-4" style="color:var(--hms-stone);font-weight:500">Tài khoản</dt>
                                        <dd class="col-sm-8 mb-0" style="font-weight:600;word-break:break-all">
                                            <c:out value="${emailConfig.username}"/>
                                        </dd>

                                        <dt class="col-sm-4" style="color:var(--hms-stone);font-weight:500">Mật khẩu</dt>
                                        <dd class="col-sm-8 mb-0" style="color:var(--hms-stone)">
                                            ••••••••
                                            <span class="badge-hms badge-neutral" style="font-size:0.625rem;margin-left:4px">Đã ẩn</span>
                                        </dd>

                                        <dt class="col-sm-4" style="color:var(--hms-stone);font-weight:500">Email gửi đi</dt>
                                        <dd class="col-sm-8 mb-0" style="font-weight:600;word-break:break-all">
                        ...
                        <div class="col-lg-5">
                            <div class="widget-surface">
                                ...
                                <div class="widget-surface-body" style="font-size:0.8125rem;color:var(--hms-stone);line-height:1.6">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-7">
                            <div class="widget-surface">
                                ...
                                <div class="widget-surface-body">
                                    <dl class="row mb-0" style="font-size:0.9rem;row-gap:0.5rem">
                                        <dt class="col-sm-4" style="color:var(--hms-stone);font-weight:500">Pay URL</dt>
                                        <dd class="col-sm-8 mb-0" style="font-weight:600;word-break:break-all;font-size:0.8125rem">
                                            <c:out value="${vnpayConfig.payUrl}"/>
                                        </dd>

                                        <dt class="col-sm-4" style="color:var(--hms-stone);font-weight:500">Return URL</dt>
                                        <dd class="col-sm-8 mb-0" style="font-weight:600;word-break:break-all;font-size:0.8125rem">
                                            <c:out value="${vnpayConfig.returnUrl}"/>
                                        </dd>

                                        <dt class="col-sm-4" style="color:var(--hms-stone);font-weight:500">Mã Merchant</dt>
                                        <dd class="col-sm-8 mb-0" style="font-weight:600">
                                            <c:out value="${vnpayConfig.tmnCode}"/>
                                        </dd>

                                        <dt class="col-sm-4" style="color:var(--hms-stone);font-weight:500">Khóa bí mật</dt>
                                        <dd class="col-sm-8 mb-0" style="color:var(--hms-stone)">
                                            ••••••••
                                            <span class="badge-hms badge-neutral" style="font-size:0.625rem;margin-left:4px">Đã ẩn</span>
                                        </dd>

                                        <dt class="col-sm-4" style="color:var(--hms-stone);font-weight:500">API URL</dt>
                                        <dd class="col-sm-8 mb-0" style="font-weight:600;word-break:break-all;font-size:0.8125rem">
                            ...
                            <div class="widget-surface">
                                ...
                                <div class="widget-surface-body" style="font-size:0.8125rem;color:var(--hms-stone);line-height:1.6">
                                    ...
                                    <div style="background:var(--hms-bg-soft);border-radius:var(--hms-radius-sm);
                                        ...
                                        Sai <em>Pay URL</em> hoặc <em>API URL</em> sẽ làm hỏng toàn bộ luồng thanh toán.
...
<div class="modal fade" id="emailEditModal" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content" style="border-radius:var(--hms-radius-lg);border:1px solid var(--hms-border)">
            <form action="${ctx}/admin/system-config/email" method="post"
                  id="formEmailEdit" novalidate>
                <input type="hidden" name="csrfToken" value="${csrfToken}"/>

                <div class="modal-header" style="border-bottom:1px solid var(--hms-border-soft);padding:1.25rem 1.5rem">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="vnpayTmnCode" name="tmnCode"
                                   value="<c:out value='${vnpayConfig.tmnCode}'/>"
                                   required>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="password" class="form-control" id="vnpaySecretKey" name="secretKey"
                                       placeholder="••••••••" autocomplete="new-password" required>
                                <button type="button" class="btn btn-outline-secondary"
