                            ...
                            <form action="${ctx}/login" method="post" class="auth-stagger-3">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="username" name="username"
                                        value="<c:out value='${username}'/>" placeholder="Nhập tên đăng nhập" required
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <span id="togglePassword"
                                            style="position: absolute; right: 15px; top: 50%; transform: translateY(-50%); cursor: pointer; color: var(--hms-text-muted);">
                                            ...
                                            <svg id="eye-off-icon" style="display:none;" width="18" height="18"
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-4 auth-stagger-4">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label text-muted" for="remember"
                                            style="font-size:0.875rem">Ghi nhớ đăng nhập</label>
                                    </div>
                                    <a href="${ctx}/forgot-password" class="text-decoration-none"
                                        style="font-size:0.875rem;color:var(--hms-accent);font-weight:500;">Quên mật
                                        khẩu?</a>
                                </div>
                                <div class="text-center auth-stagger-4 mb-3">
                                    <button type="submit" class="btn btn-mintlify-primary py-2 px-5"
                                        style="font-size:1rem; min-width: 220px;">Đăng nhập</button>
                                </div>
                            </form>
                        </div>
                    </div>
