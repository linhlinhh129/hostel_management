                                ...
                                <c:if test="${not empty post}">
                                    <div class="post-card">
                                        ...
                                        <div class="post-stats">
                                            ...
                                            <span id="comment-count-${post.id}">💬 ${post.totalComments} bình
                                                luận</span>
                                        </div>
                                        ...
                                        <div class="post-actions">
                                            <button class="action-btn ${post.likedByCurrentUser ? 'liked' : ''}"
                                                id="btn-like-${post.id}" onclick="toggleLike(${post.id})">
                                                <i
                                                    class="${post.likedByCurrentUser ? 'fa-solid' : 'fa-regular'} fa-thumbs-up"></i>
                                                Thích
                                            </button>
                                        ...
                                        <div class="comment-section" id="comments-section-${post.id}"
                                            ...
                                            <div class="comment-list" id="comment-list-${post.id}">
                                                <div class="text-center text-muted small py-2"><i
                                                        class="fa fa-spinner fa-spin"></i> Đang tải...</div>
                                            </div>
                                            <div class="comment-input-area">
                                                ...
                                                <input type="text" class="comment-input" id="comment-input-${post.id}"
                                                    ...
                                                    onkeypress="handleCommentEnter(event, ${post.id})" maxlength="1000">
                                                <button class="btn btn-mintlify btn-send"
                                                    onclick="submitComment(${post.id})"><i
