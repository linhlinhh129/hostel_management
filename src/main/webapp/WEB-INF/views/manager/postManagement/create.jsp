...
<div class="app-shell">
    ...
    <div class="main-wrapper">
        ...
        <main class="page-content">
            ...
            <div class="post-card">
                <div class="p-2">
                    <form action="${ctx}/manager/articles/create?csrfToken=${csrfToken}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex flex-wrap gap-2 mb-2">
                                ...
                                <!-- Chọn từ thư viện -->
                                <div class="position-relative">
                                    <input type="file" id="fileInput" name="image" accept="image/png, image/jpeg, image/jpg" class="d-none">
                                    <label for="fileInput" class="btn upload-btn-outline fw-medium mb-0">
                                        <i class="bi bi-images me-1"></i> Tải ảnh lên
                                    </label>
                                </div>
                            </div>
                            <div class="text-muted small">Hỗ trợ JPG, PNG. Tối đa 5MB.</div>
