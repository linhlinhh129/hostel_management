            ...
            <div class="main-wrapper">
              ...
              <main class="page-content">
                ...
                <div
                  ...
                  <a href="${ctx}/manager/tickets?type=${ticket.senderRole}" class="btn-mintlify-secondary text-decoration-none">← Danh sách</a>
                </div>
                          ...
                          <div class="widget-surface-body p-0">
                            <table style="width:100%;font-size:0.875rem;border-collapse:collapse">
                              <tr style="border-bottom:1px solid var(--hms-border)">
                                <td style="padding:9px 14px;color:var(--hms-text-muted);white-space:nowrap">Người
                                  gửi</td>
                                <td style="padding:9px 14px">
                                  <c:choose>
                                    <c:when test="${ticket.senderRole == 'OPERATOR'}">
                                      <c:out value="${ticket.senderName}" /> <span class="badge bg-secondary">Nhân
                                        viên</span>
                                    </c:when>
                                    <c:otherwise>
                          ...
                          <div class="widget-surface">
                            ...
                            <div class="widget-surface-body">
                              <c:choose>
                                ...
                                <%-- GIỮ NGUYÊN LUỒNG CŨ CHO CƯ DÂN (TENANT) --%>
                                <c:otherwise>
                                  <c:choose>
