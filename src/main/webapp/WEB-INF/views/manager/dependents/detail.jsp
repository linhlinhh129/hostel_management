    ...
    <main class="page-content">
      ...
      <div class="page-header hero-sky-gradient d-flex flex-wrap justify-content-between align-items-start gap-3" style="border-radius:var(--hms-radius-lg);margin-bottom:1.75rem">
        <div>
          ...
          <p>Người phụ thuộc của <a href="${ctx}/manager/tenants/${dependent.tenantId}"><c:out value="${dependent.tenantName}"/></a></p>
        </div>
      ...
      <div class="row g-3">
            ...
            <div class="widget-surface-body">
              <table style="width:100%;font-size:0.875rem;border-collapse:collapse">
                <tr>
                  ...
                  <td style="padding:6px 0;font-weight:500"><c:out value="${dependent.fullName}"/></td>
                </tr>
                <tr>
                  <td style="padding:6px 0;color:var(--hms-text-muted)">Ngày sinh</td>
                  <td style="padding:6px 0"><c:out value="${dependent.dob}"/></td>
                </tr>
                <tr>
                  ...
                  <td style="padding:6px 0">
                    <c:choose>
                      ...
                      <c:otherwise><c:out value="${dependent.gender}"/></c:otherwise>
                    </c:choose>
                  </td>
                </tr>
                <tr>
                  <td style="padding:6px 0;color:var(--hms-text-muted)">Quan hệ</td>
                  <td style="padding:6px 0"><c:out value="${dependent.relationship}"/></td>
                </tr>
                <tr>
        ...
        <div class="col-lg-7">
              ...
              <div class="d-flex align-items-center gap-3">
                <div>
                  <div style="font-weight:600;font-size:1rem">
                    <a href="${ctx}/manager/tenants/${dependent.tenantId}" style="text-decoration:none;color:var(--hms-accent-deep)">
          ...
          <%-- Cập nhật thông tin --%>
          <div class="widget-surface mb-3">
            <div class="widget-surface-header"><h3>Cập nhật thông tin</h3></div>
            <div class="widget-surface-body">
              <form method="post" action="${ctx}/manager/dependents/${dependent.id}/edit">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="edit_fullName" name="fullName"
                         required maxlength="200" value="<c:out value='${dependent.fullName}'/>">
                </div>
                <div class="mb-3">
                  <label for="edit_relationship" class="form-label">Quan hệ <span class="text-danger">*</span></label>
                ...
                <div class="row g-3 mb-3">
                  <div class="col-sm-6">
                    ...
                    <select class="form-select" id="edit_gender" name="gender">
                      ...
                      <option value="FEMALE" ${dependent.gender == 'FEMALE' ? 'selected' : ''}>Nữ</option>
                      <option value="OTHER"  ${dependent.gender == 'OTHER'  ? 'selected' : ''}>Khác</option>
                    </select>
                  </div>
                  <div class="col-sm-6">
          ...
          <%-- Xóa người phụ thuộc --%>
          <div class="data-surface" style="border-left:4px solid var(--hms-danger);padding:1rem 1.25rem">
            <h6 style="font-weight:600;color:var(--hms-danger);margin-bottom:0.5rem">Xóa người phụ thuộc</h6>
