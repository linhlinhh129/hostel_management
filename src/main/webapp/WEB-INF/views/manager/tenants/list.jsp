          ...
          <div class="main-wrapper">
            ...
            <main class="page-content">
              ...
              <div class="data-surface">
                <form method="get" action="${ctx}/manager/tenants" id="filterForm" class="mb-4 p-3 rounded"
                  ...
                  <div class="row g-3 align-items-end">
                    <div class="col-12 col-md-4">
                      <label class="form-label"
                        ...
                        kiếm</label>
                      <input type="text" class="form-control" name="keyword" placeholder="Tên / SĐT / Email..."
                    ...
                    <div class="col-12 col-md-4 d-flex justify-content-md-end gap-2">
                      <a href="${ctx}/manager/tenants" class="btn btn-light border text-decoration-none"
                ...
                <c:choose>
                  <c:when test="${not empty page.items}">
                    ...
                    <div class="table-footer d-flex justify-content-between align-items-center px-3 py-2">
                      <span class="text-muted" style="font-size:0.875rem">
                        Tổng
                        <fmt:formatNumber value="${page.total}" groupingUsed="true" /> người thuê
                  ...
                  <c:otherwise>
                    <div class="empty-state p-4 text-center">
                      ...
                      <p class="text-muted">Vui lòng tạo hợp đồng trước, sau đó tạo tài khoản người thuê tại trang chi
                        tiết hợp đồng.</p>
                    </div>
                  </c:otherwise>
                </c:choose>
