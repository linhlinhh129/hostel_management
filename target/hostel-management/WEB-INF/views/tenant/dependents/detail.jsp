...
<div class="tenant-card"><p><strong>Ngày sinh:</strong> <c:out value="${dependent.dobLabel}"/></p><p><strong>SĐT:</strong> <c:out value="${dependent.phone}"/></p><p><strong>CCCD:</strong> <c:out value="${dependent.idCardNumber}"/></p><p><strong>Email:</strong> <c:out value="${dependent.email}"/></p><p><strong>Quan hệ:</strong> <c:out value="${dependent.relationship}"/></p></div>
